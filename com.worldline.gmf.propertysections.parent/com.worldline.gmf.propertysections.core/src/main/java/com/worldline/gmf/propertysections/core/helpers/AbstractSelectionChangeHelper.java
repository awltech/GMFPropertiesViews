package com.worldline.gmf.propertysections.core.helpers;
...
/**
 * AbstractTextChangeHelper notifies the listener of Selectionable widgets lifecycle
 ...
 */
public abstract class AbstractSelectionChangeHelper extends AbstractControlChangeHelper {
